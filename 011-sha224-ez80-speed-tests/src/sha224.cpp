/****************************************************************
	2024/09/08 20:14 NZT
	SHA-224 software implementation

	(following implementation from the book "" and my previous
	  implementation adapted to Microsoft C#)
  * Translated into Agon Light (eZ80F92 MPU) SDK and data types.
...
char* sha224_hash(byte *arrData, long totalDataLen)
{
	...
	// Initialise internal state for SHA-224 calculations (different from SHA-256 initial constants).
	h[0] = 0xc1059ed8UL;
	h[1] = 0x367cd507UL;
	h[2] = 0x3070dd17UL;
	h[3] = 0xf70e5939UL;
