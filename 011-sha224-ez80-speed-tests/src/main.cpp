/*******************************************************************************
	[2024/09/08 20:16 NZT]
	011-sha224-ez80-speed-tests
	(using eZ80 CEdev/AgDev C/C++ environment in GNU/Linux for Agon Light 2 microcomputer)
	
	* SHA-224-implemented-in-software version.
	* Zilog eZ80F92 CPU calculated different SHA-224 hashes over different given strings
	    and displays the original text with it SHA-224 hash directly in a text file inside
...
int main()
{
	...
	printf("[2024/09/12 23:13 NZT]\n");
	printf("[  SHA-224 hashing test calculation over different strings  ]\n");
	printf("[   -- measure of time used for calculation of SHA-224 --   ]\n");
	printf("[            -- over different string lengths  --           ]\n");
	printf("=============================================================\n\n");

	fprintf(f, " Agon Light 2 (Zilog eZ80F92 Acclaim! CPU)\n");
	fprintf(f, "[2024/09/12 23:13 NZT]\n");
	fprintf(f, "[  SHA-224 hashing test calculation over different strings  ]\n");
	fprintf(f, "[   -- measure of time used for calculation of SHA-224 --   ]\n");
