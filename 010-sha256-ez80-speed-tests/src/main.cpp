/*******************************************************************************
	...
	010-sha256-ez80-speed-tests
	(using eZ80 CEdev/AgDev C/C++ environment in GNU/Linux for Agon Light 2 microcomputer)
	
	* MD5-implemented-in-software version.
	* Zilog eZ80F92 CPU calculated different SHA-256 hashes over different given strings
	    and displays the original text with it SHA-256 hash directly in a text file inside
...
int main()
{
	...
	printf("[2024/08/24 18:50 NZT]\n");
	printf("[SHA-256 hashing test calculation over different strings]\n");
	...
	fprintf(f, "[2024/08/24 18:50 NZT]\n");
	fprintf(f, "[SHA-256 hashing test calculation over different strings]\n");
