...
void NumTools_printArray_b2(byte *arr, int maxBlocks16bytes, byte cols, boolean asHex);
void NumTools_printArray_b2f(FILE* f, byte *arr, int maxBlocks16bytes, byte cols, boolean asHex);
//void NumTools_printArray_b(byte *arr, int maxElements, byte cols, boolean asHex, boolean inoneline, boolean withSpaces);
