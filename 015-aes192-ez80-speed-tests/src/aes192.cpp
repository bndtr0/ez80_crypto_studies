/********************************************************
	...
	2024/09/06 18:12 NZT
	AES-192 implementation
	
	* Based on FIPS-197 document (FIPS.197-upd1.pdf).
 	* Translated into Raspberry Pi Pico environment and data types
...
//-----------------------------------------------------------------------------------
byte *aes192_crypt(byte* msgInputArr, byte* keyArr, byte *msgOutputArr, int msgLen)
{
	...
	for(i = 0; i < ml; i += 16)
	{
		aes192_calculate(msgInputArr + i, keyArr, msgOutputArr + i);
		//Serial.print("[[1]] ");
	...
	if(ml <= msgLen)
	{
		...
		aes192_calculate(msgInputArr + ml, keyArr, msgOutputArr + ml);
		//Serial.print("[[2]] ");
...
//-----------------------------------------------------------------------------------
void aes192_calculate(byte* msgInputArr, byte* keyArr, byte *msgOutputArr)
{	
